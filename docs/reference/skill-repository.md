...
- 이 저장소는 `semantic-boundary-design` 독립 스킬 패키지다.
...
- 배포 계약은 `skills/semantic-boundary-design/SKILL.md`가 소유한다.
- 방향과 진화 기준은 `docs/skill-direction.md`가 소유한다.
- README는 소개, 설치, 사용 진입점, 지원, 라이선스만 맡는다.
- 특정 저장소나 특정 구현 사례에 의존하는 내용을 배포 스킬에 넣지 않는다.
